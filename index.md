...
venue: "CQ University"        # brief name of host site without address (e.g., "Euphoric State University")
...
email: ["j.bell@cqu.edu.au","mark.crowe@qcif.edu.au"]    # boxed, comma-separated list of contact email addresses for the host, lead instructor, or whoever else is handling questions, like ["marlyn.wescoff@example.org", "fran.bilas@example.org", "ruth.lichterman@example.org"]
